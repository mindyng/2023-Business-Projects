...
SELECT CONCAT('$', ROUND(AVG(CASE WHEN transaction_type1 = 'CHURN' THEN subscription_price1 
		   WHEN transaction_type2 = 'CHURN' THEN subscription_price2
		   WHEN transaction_type3 = 'CHURN' THEN subscription_price3
		   WHEN transaction_type4 = 'CHURN' THEN subscription_price4
		   END), 2)) AS avg_churn_price		   
FROM pivot 
